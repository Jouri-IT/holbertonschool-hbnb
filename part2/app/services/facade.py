...
class HBnBFacade:
    ...
    def create_user(self, user_data):
        ...
        Email uniqueness is enforced here (against user_repo) as well
        as in the API layer, so direct facade callers -- not jus
        HTTP requests -- can't create two users with the same email.
        """
    ...
    def create_place(self, place_data):
        ...
        # place_data should contain owner_id; fetch the User objec
    ...
    def create_review(self, review_data):
        ...
        every other create_* method) -- place_id/user_id are read ou
